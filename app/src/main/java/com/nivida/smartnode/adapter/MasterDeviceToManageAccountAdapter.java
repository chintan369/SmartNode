 ...
 */
public class MasterDeviceToManageAccountAdapter extends BaseAdapter {
    ...
    public MasterDeviceToManageAccountAdapter(Context context, List<Bean_Master> masterList){
    ...
    public void notifyDataSetChanged() {
        masterList.clear();
        masterList=databaseHandler.getAllMasterDeviceDataWOADD();

...
public class SwitchScheduleItemAdapter2 extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        chk_enable.setChecked(scheduleItemList.get(position).isSchEnabled());
    ...
    public void deleteItem(int position) {
        ...
        Log.e("Slot to Delete", position + "--> " + scheduleItemList.get(position).getSlot_num());

        if (!scheduleItemList.get(position).getSlot_num().isEmpty() && !scheduleItemList.get(position).getSlot_num().trim().equalsIgnoreCase("26")) {
            onScheduleViewSelection.deleteSchedule(position, scheduleItemList.get(position), position);
            notifyDataSetChanged();
        } else if (scheduleItemList.get(position).getSlot_num().trim().equalsIgnoreCase("26")) {

            Log.e("slot", "--" + scheduleItemList.get(position).getSlot_num());
